...
class AuthenticationCookie extends AuthenticationPlugin
{
    ...
    if (count($GLOBALS['cfg']['Servers']) >= 1 && '' !== $GLOBALS['cfg']['Servers'][1]['socket']) {
    ...
    <form method="post" id="login_form" action="index.php" name="login_form"' , $autocomplete ,
        ...
        Message::rawError(
            "<b>MariaDB 5</b> or <b>MariaDB 10</b> is stopped or has not been installed. Please check the package on your DSM first."
        )->display();
    }
