...
return [
    ...
    "two_factor" => [
        ...
        "recovery" => [
            "heading" => "Двухфакторная аутентификация",
            "description" => "Пожалуйста, подтвердите доступ, введя один из ваших кодов аварийного восстановления",
        ],
    ...
    "profile" => [
        ...
        "sanctum" => [
            "title" => "API Токены",
            "description" => "правление токенами API, которые позволяют сторонним службам получать доступ к этому приложению от вашего имени. ПРИМЕЧАНИЕ. Ваш токен отображается один раз при создании. Если вы потеряете свой токен, вам нужно будет удалить его и создать новый",
            "create" => [
