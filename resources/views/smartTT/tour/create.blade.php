        ...
        <div class="card mt-2">
            ...
            <div class="card-body">
                <div class="mb-3">
                    ...
                    <input type="text" name="place[]" class="form-control" id="place.1" value="{{ old('place.0') }}"
                        placeholder="Enter the main visit place 1">
                    @error('place.0')
                        <span class="help-block" role="alert">
                            <strong>{{ $message }}</strong>
                        </span>
                ...
                <div class="mb-3">
                    ...
                    <input type="text" name="place[]" class="form-control" id="place.2" value="{{ old('place.1') }}"
                        placeholder="Enter the main visit place 2">
                    @error('place.1')
                        <span class="help-block" role="alert">
                            <strong>{{ $message }}</strong>
                        </span>
                ...
                <div class="mb-3">
                    ...
                    <input type="text" name="place[]" class="form-control" id="place.3" value="{{ old('place.2') }}"
                        placeholder="Enter the main visit place 3">
                    @error('place.2')
                        <span class="help-block" role="alert">
                            <strong>{{ $message }}</strong>
                        </span>
