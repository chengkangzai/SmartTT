...
<div class="flex min-h-screen flex-col overscroll-none">
    <header class="fixed top-0 z-50 w-full">
        <div class="bg-gray-200 dark:bg-gray-700 dark:text-gray-200">
            <div
                class="hidden md:flex mx-auto flex container flex-col px-4 md:flex-row md:items-center md:justify-between md:px-6 lg:px-8">
                <p class="px-2 text-xs inline">
        ...
        <div class="bg-gray-200 dark:bg-gray-800 dark:text-gray-200">
            <div x-data="{ open: false }"
                 class="mx-auto container flex flex-col px-4 py-2 md:flex-row md:items-center md:justify-between md:px-6 lg:px-8">
                <div class="flex flex-row items-center justify-between">
                    <a href="{{ route('front.index') }}"
                       class="hover:text-gray-300 focus:shadow-outline rounded-lg text-lg uppercase tracking-widest focus:outline-none font-bold">
                        {{ $setting->site_name }}
                    </a>
    ...
    <div class="flex flex-1 flex-col md:flex-row">
        <main class="w-full flex-1 bg-white md:px-0">
            @yield('content')
        </main>
    </div>
