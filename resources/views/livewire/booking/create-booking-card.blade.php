    ...
    <div class="card-body">
        ...
        @if ($currentStep == 4)
            ...
            <table class="table table-bordered">
                <tr>
                    <td><p class="float-end">{{ __('Tour Name') }}</p></td>
                    <td>{{ $tourModel->name }}</td>
                </tr>
                <tr>
                    <td><p class="float-end">{{ __('Itinerary') }}</p></td>
                    <td>
                ...
                <tr>
                    <td><p class="float-end">{{ __('Depart Date') }}</p></td>
                    <td>{{ $packageModel->depart_time->toDayDateTimeString() }}</td>
                </tr>
                <tr>
                    <td><p class="float-end">{{ __('Guests') }}</p></td>
                    <td>
                        <table class="table table-bordered">
                            <thead>
                            <tr>
