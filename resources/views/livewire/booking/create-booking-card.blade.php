        ...
        @if ($currentStep == 5)
            <div class="row">
                ...
                <div class="btn-group row mx-0 ">
                    ...
                    <button class="col-md-6 btn {{ $paymentType == 'deposit' ? 'btn-primary' : 'btn-outline-primary'}}"
                ...
                <div class="btn-group row mx-0">
                    <button class="col-md-6 btn {{ $paymentMethod == 'manual' ? 'btn-primary' : 'btn-outline-primary'}}"
                            wire:click="$set('paymentMethod','manual')">
                        {{ __('Manual') }}
                    </button>
                    <button class="col-md-6 btn {{ $paymentMethod == 'stripe' ? 'btn-primary' : 'btn-outline-primary'}}"
