        ...
        <div class="rounded-xl border p-2">
            ...
            <div class="flex flex-col gap-2 md:flex-row">
                <div class="flex w-full flex-col gap-1">
                    ...
                    <input type="number" class="rounded-lg" id="price_from" wire:model.debounce="priceFrom" placeholder="{{ __('From') }}"
                           value="{{ now()->addMonth()->format('Y-m-d') }}">
                </div>
                <div class="flex w-full flex-col gap-1">
                    <label for="price_to" class="block px-2 text-sm opacity-70">{{ __('To') }}</label>
                    <input type="number" class="rounded-lg" id="price_to" wire:model.debounce="priceTo" placeholder="{{ __('To') }}"
